...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'wplsyx', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一位很菜的CTFer', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.wplsyx.cn/', // 网站地址
  ...
  // RSS订阅
  //ENABLE_RSS: process.env.NEXT_PUBLIC_ENABLE_RSS || '', // 是否开启RSS订阅功能
